...
API_BASE_URL = getenv("API_URL", "https://deadlineTech.site")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Cloning_Music_Bot")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/fzpvz0.jpg"
)
PING_IMG_URL = getenv(
